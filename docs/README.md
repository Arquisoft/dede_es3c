...
The deployment url is: [https://arquisoft.github.io/dede_es3c/](https://arquisoft.github.io/dede_es3c/).
...
If we want to deploy it to GitHub pages, so it is accesible via [https://arquisoft.github.io/dede_es3c/](https://arquisoft.github.io/dede_es3c/) we need to execute `npm run deploy`.
